...
const M1_ManagerShiftSlide: React.FC<SlideProps> = ({ onNext, onPrev }) => (
  <div className="max-w-4xl mx-auto px-6 py-8 flex flex-col justify-center h-full">
    ...
    <div className="prose prose-lg text-gray-600 mb-8">
      ...
      <p className="mb-4">This module tackles the hardest psychological hurdle for new leaders: <strong>Letting go of the 'doing'.</strong></p> 
      <p>When you solve every problem yourself, you become the bottleneck. Your new job is to build a system where others can solve problems. This requires a shift from reactive task-management to proactive vision-setting.</p>
    </div>
...
const M1_VisionTheorySlide: React.FC<SlideProps> = ({ onNext, onPrev }) => (
  <div className="max-w-4xl mx-auto px-6 py-8">
    <h2 className="text-3xl font-bold text-indigo-text mb-4 border-b border-indigo-luna/30 pb-4">Vision Provides Direction</h2>
    
    <div className="bg-indigo-50/50 p-6 rounded-xl border border-indigo-100 mb-8">
        <h4 className="font-bold text-indigo-text mb-2">Why does this matter?</h4>
        <p className="text-gray-700">At Indigo Luna, we don't just sell clothes; we sell a philosophy. Without a clear vision, your team is just completing tasks listlessly. With vision, every folded garment and answered email becomes part of a bigger mission.</p>
    </div>
...
const M1_StartWithWhySlide: React.FC<SlideProps> = ({ onNext, onPrev }) => (
  <div className="max-w-4xl mx-auto px-6 py-8">
    ...
    <div className="bg-white p-6 rounded-xl shadow-sm border-l-4 border-indigo-luna mb-8 text-gray-700 leading-relaxed">
        <p className="mb-2">People don't buy <strong>what</strong> you do; they buy <strong>why</strong> you do it. This applies to your team too.</p>
        <p>If you only talk about tasks (What) and processes (How), you get compliance. If you talk about purpose (Why), you get commitment and loyalty. We use this framework to communicate with impact.</p>
    </div>
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-8">
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold text-indigo-text mb-3">The S.M.A.R.T. Framework</h2>
        <p className="max-w-2xl mx-auto text-gray-600">A Vision is a destination, but Goals are the map. Without specific milestones, a vision is just a hallucination. We use this framework to ensure every dream has a deadline and a metric.</p>
      </div>
...
const M1_TaskVsResultSlide: React.FC<SlideProps> = ({ onNext, onPrev }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-8">
      <div className="mb-8">
          <div className="flex items-center gap-3 mb-2"><TrendingUp className="text-indigo-luna" size={32} /><h2 className="text-3xl font-bold text-indigo-text">The "Busy" Trap</h2></div>
          <p className="text-gray-600 mb-2">It is easy to feel productive because you are tired at the end of the day. But activity does not equal impact.</p>
          <p className="text-gray-700 font-medium">As a manager, you must shift your mindset from "Hours Spent" (Tasks) to "Value Created" (Results).</p>
      </div>
...
const M2_PillarsSlide: React.FC<SlideProps> = ({ onNext, onPrev }) => (
  <div className="max-w-4xl mx-auto px-6 py-8">
    ...
    <p className="text-gray-600 mb-8 text-lg">Communication is the nervous system of your department. If it's blocked, the body fails. We focus on three critical pillars that ensure information flows, people feel heard, and issues are resolved.</p>
...
const M2_OpenQuestionsSlide: React.FC<OpenQuestionProps> = ({ onNext, onPrev, q1, setQ1, q2, setQ2, q3, setQ3 }) => {
  return (
    <div className="max-w-4xl mx-auto px-6 py-8">
      ...
      <div className="bg-indigo-50/50 p-6 rounded-xl border border-indigo-100 mb-8">
          <p className="text-gray-700 leading-relaxed">
             Most new managers try to 'save' their team by giving answers. This creates dependency. <strong>Open-Ended Questions</strong> flip the dynamic: they force your team members to think, problem-solve, and grow. Stop solving; start asking.
          </p>
      </div>

      <p className="text-gray-600 mb-6">Rewrite the following "Closed" questions to be "Open" to invite story and reflection.</p>
...
const M2_SBISlide: React.FC<SBIProps> = ({ onNext, onPrev, pastContext, setPastContext, situation, setSituation, behavior, setBehavior, impact, setImpact }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-8 h-full flex flex-col">
      ...
      <div className="bg-indigo-50/50 p-6 rounded-xl border border-indigo-100 mb-8">
          <p className="text-gray-700 leading-relaxed">
             Feedback is high-stakes. If it feels like an attack on character ("You're lazy"), people shut down. If it's too soft ("Good job"), nothing changes. The <strong>SBI Model</strong> strips away emotion and interpretation, focusing purely on data. This reduces defensiveness and makes the feedback undeniable.
          </p>
      </div>
...
const M2_ConflictSlide: React.FC<ConflictProps> = ({ onNext, onPrev, setConflictStyle, conflictStyle }) => {
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-8">
      ...
      <div className="bg-indigo-50/50 p-6 rounded-xl border border-indigo-100 mb-8">
          <p className="text-gray-700 leading-relaxed">
             Conflict isn't bad; it's a sign of diverse ideas. The problem isn't the conflict, it's how we react to it. Everyone has a default style. By identifying your 'default setting', you can choose to react differently when the situation requires a different approach.
          </p>
      </div>

      <p className="text-gray-600 mb-6"><strong>Select the one that best matches your natural tendency</strong> to move forward.</p>
...
const M2_ActionPlanSlide: React.FC<CommActionPlanProps> = ({ onNext, onPrev, sbi, conflictStyle, challenge }) => (
  <div className="max-w-4xl mx-auto px-6 py-8">
    ...
    <div className="bg-indigo-50/50 p-6 rounded-xl border border-indigo-100 mb-8">
        <h4 className="font-bold text-indigo-text mb-2">From Theory to Practice</h4>
        <p className="text-gray-700 leading-relaxed">
            Now that you have explored the frameworks, you will meet with Clara to discuss how to apply them to your specific team dynamics.
            This catch-up will focus on role-playing difficult conversations and understanding your conflict style.
            <br/><br/>
            <strong>Please ensure you have reflected on and are ready to discuss the following:</strong>
        </p>
    </div>
